...
def main():
    ...
    # Delaying import avoids circular load dependency
    from . import functions

    # Change the path to WEKA to the appropriate location on your computer if necessary
    from .data import WEKA_PATH
    # This contains paths to models
    from . import data
    ...
    f_output = pjoin(RESULTS_PATH, 'short_ids.fasta')
    ...
    weka_input = pjoin(RESULTS_PATH, 'weka.arff')
    ...
    if FUNGAL_MODE == True:
        ensembl_votes_cytoplasmic = functions.get_model_predictions(WEKA_PATH, RESULTS_PATH, data.models_bayes_cytoplasmic_fungionly, 'weka.classifiers.bayes.NaiveBayes', ensembl_votes_cytoplasmic, ORIGINAL_IDENTIFIERS, SEQUENCES)
        print('25 percent done...')

        ensembl_votes_cytoplasmic = functions.get_model_predictions(WEKA_PATH, RESULTS_PATH, data.models_J48_cytoplasmic_fungionly, 'weka.classifiers.trees.J48', ensembl_votes_cytoplasmic, ORIGINAL_IDENTIFIERS, SEQUENCES)
        print('50 percent done...')


    if FUNGAL_MODE == False:
        ensembl_votes_cytoplasmic = functions.get_model_predictions(WEKA_PATH, RESULTS_PATH, data.models_bayes_cytoplasmic, 'weka.classifiers.bayes.NaiveBayes', ensembl_votes_cytoplasmic, ORIGINAL_IDENTIFIERS, SEQUENCES)
        print('25 percent done...')

        ensembl_votes_cytoplasmic = functions.get_model_predictions(WEKA_PATH, RESULTS_PATH, data.models_J48_cytoplasmic, 'weka.classifiers.trees.J48', ensembl_votes_cytoplasmic, ORIGINAL_IDENTIFIERS, SEQUENCES)
        print('50 percent done...')

    ensembl_votes_apoplastic = functions.get_model_predictions(WEKA_PATH, RESULTS_PATH, data.models_bayes_apoplastic, 'weka.classifiers.bayes.NaiveBayes', ensembl_votes_apoplastic, ORIGINAL_IDENTIFIERS, SEQUENCES)
    print('75 percent done...')

    ensembl_votes_apoplastic = functions.get_model_predictions(WEKA_PATH, RESULTS_PATH, data.models_J48_apoplastic, 'weka.classifiers.trees.J48', ensembl_votes_apoplastic, ORIGINAL_IDENTIFIERS, SEQUENCES)
    #--------------------------------------------------------------
    print('All done.')
    print()
    #--------------------------------------------------------------
